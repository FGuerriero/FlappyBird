...
// const bUp = new Barreira(true)
// bUp.setAltura(200)
// document.querySelector('[wm-flappy]').appendChild(bUp.elemento)
...
function Barreiras(altura, largura, abertura, espaco, notificarPonto) {
    ...
    this.animar = () => {
        this.pares.forEach( par => {
            ...
            const cruzouOMeio = ((par.getX()+par.getLargura() + deslocamento) >= meio ) && (par.getX()+par.getLargura()) < meio
